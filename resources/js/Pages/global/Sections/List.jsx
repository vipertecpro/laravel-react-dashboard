...
export default function List({auth, pageTitle,pageDescription}) {
    const actionUrls = [{
        removeRouteName : 'dashboard.global.sections.remove',
        editRouteName : 'dashboard.global.sections.edit'
    }]
    return (
        <AuthenticatedLayout
            user={auth.user}
            ...
            <div className="m-5 p-5 flow-root shadow sm:rounded-lg">
                <div className="sm:flex sm:items-center">
                    ...
                    <div className="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                        <Link
                            href={route('dashboard.global.sections.create')}
                ...
                <div className="mt-8 flow-root">
                    <DataTable
                        excludedColumns={['id']}
                        fetchUrl={route('fetch.sections')}
                        columns={['id','name', 'slug', 'description', 'is_active', 'guard_name', 'user_type', 'record_access', 'created_at', 'updated_at']}
