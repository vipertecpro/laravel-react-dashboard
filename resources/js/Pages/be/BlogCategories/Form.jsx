...
export default function Form({auth, pageTitle, pageDescription, pageData, formUrl, blog_categories}) {
            ...
            <div className="m-5 p-5 flow-root shadow sm:rounded-lg">
                ...
                <form onSubmit={submit} className="space-y-6 py-4" encType={`multipart/form-data`}>
                        ...
                        <div>
                            ...
                            <div className="mt-2">
                                ...
                                >
                                    ...
                                    {blog_categories.length > 0  ? blog_categories.map((bc_data, key) => {
                                        return (<>
                    ...
                    <div className="flex items-center justify-end align-middle gap-2 pt-3 border-t">
                        <Link
                            href={route('dashboard.be.blogCategories.list')}
