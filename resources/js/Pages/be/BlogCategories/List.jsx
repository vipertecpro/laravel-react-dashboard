...
export default function List({auth, pageTitle,pageDescription}) {
    const actionUrls = {
        createEditRouteName : 'dashboard.be.blogCategories.create',
        removeAllRouteName : 'dashboard.be.blogCategories.removeAll',
        removeRouteName : 'dashboard.be.blogCategories.remove',
        editRouteName : 'dashboard.be.blogCategories.edit'
    }
    const {
        get : destroyAll,
    } = useForm();
        ...
        >
            ...
            <div className="m-5 p-5 flow-root shadow sm:rounded-lg">
                ...
                <div className="mt-8 flow-root">
                    <DataTable
                        excludedColumns={['id']}
                        fetchUrl={route('fetch.blogCategories')}
                        columns={['id','name', 'slug', 'parent_id', 'is_active', 'created_at', 'updated_at']}
